...
import { VINLAND } from '../bdd/vinland';
import { Anime } from '../modeles/anime';
import { MymodalcomponentComponent } from '../mymodalcomponent/mymodalcomponent.component';

@Component({
  selector: 'app-vinlandsaga',
  templateUrl: './vinlandsaga.component.html',
  styleUrls: ['./vinlandsaga.component.scss']
})
export class VinlandsagaComponent implements OnInit {
VINLAND = VINLAND;
